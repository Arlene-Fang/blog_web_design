...
<form action="registform.php" method="post" enctype="multipart/form-data" name="reform">
    ...
    <div class="file-field input-field">
      <div class="hoverable btn waves-effect waves-light red darken-2">
        <span>picture</span>
  ...
  <center><button type="submit" name="post" class="hoverable btn waves-effect waves-light red darken-2"/>Submit</button></center> 
</form>
