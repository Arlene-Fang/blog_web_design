...
&& in_array($extension, $allowedExts))
{
    if($_FILES["file"]["size"] < 512500){   // 小于 500 kb)
        ...
        echo "<script type='text/javascript'>alert('Successfully sign up with avatar, you can log in now.');location.href='login.php';</script>";
    }
                
    else{
        echo "<script type='text/javascript'>alert('Please upload less than 500 kb avatar :)');location.href='register.php';</script>";
    } 
}   echo "<script type='text/javascript'>alert('Successfully sign up without avatar, you can log in now.');location.href='login.php';</script>";
}
}
?>